...
export function MentorDashboardContent({ dash, activeTab, setActiveTab, logout, user }) {
  ...
  return (
      <>
        ...
        />
        {!onboardingComplete && (
            <div className="mb-6 flex items-start gap-3 rounded-2xl border border-amber-200/80 bg-gradient-to-r from-amber-50/95 to-orange-50/50 px-5 py-4 shadow-sm">
              <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-amber-600" />
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-amber-950">Complete your profile to go live</p>
                <p className="mt-0.5 text-sm text-amber-900/80">
                  You're not visible in the mentor directory yet. Finish setting up your profile to start receiving session requests.
                </p>
              </div>
              <Link
                  to="/onboarding"
                  className="shrink-0 rounded-full bg-amber-700 px-4 py-1.5 text-xs font-bold text-white shadow-sm transition hover:bg-amber-800"
              >
                Complete setup
              </Link>
            </div>
        )}
        {onboardingComplete && !calendarConnected && (
            <div className="mb-6 flex items-start gap-3 rounded-2xl border border-sky-200/80 bg-gradient-to-r from-sky-50/95 to-blue-50/40 px-5 py-4 shadow-sm">
              <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-sky-600" />
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-sky-950">Connect Google Calendar to appear in the directory</p>
                <p className="mt-0.5 text-sm text-sky-900/80">
                  Your profile is complete but you won't appear to mentees until you connect your calendar. This feature is coming soon.
                </p>
              </div>
              <Link
                  to="/onboarding"
                  className="shrink-0 rounded-full bg-sky-700 px-4 py-1.5 text-xs font-bold text-white shadow-sm transition hover:bg-sky-800"
              >
                View status
              </Link>
            </div>
